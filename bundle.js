...
minixhr('https://api.github.com/users/esovaborko85', startPage)
...
function footerComponent () {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/esovaborko85">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
      <a href="mailto:esova.borko@gmail.com ">
